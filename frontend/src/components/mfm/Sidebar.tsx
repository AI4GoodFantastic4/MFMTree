    ...
    return (
      ...
      >
        <button
          ...
          className="text-[var(--mfm-text-2)] hover:text-[var(--mfm-text)]"
        >
        ...
        {(loading || usingDemoData || error) && (
          <section className="border-b border-[var(--mfm-border)] p-4">
            ...
            {(loading || usingDemoData) && (
              ...
              >
                {loading ? "Loading area data..." : "Using demo fallback"}
              </div>
            )}
              ...
              return (
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block truncate text-[11px] font-semibold text-[var(--mfm-text)]">
                      {getCellDisplayName(p)}
                    </span>
                    <span className="block truncate font-mono text-[10px] text-[var(--mfm-text-2)]">
